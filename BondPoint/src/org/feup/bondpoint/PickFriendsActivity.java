...
public class PickFriendsActivity extends FragmentActivity {
		...
		friendPickerFragment
				.setOnDoneButtonClickedListener(new PickerFragment.OnDoneButtonClickedListener() {
					...
					public void onDoneButtonClicked(PickerFragment<?> fragment) {
						...
						ConnectActivity.FriendPickerApplication con = (ConnectActivity.FriendPickerApplication) getApplication();
						con.setSelectedUsers(friendPickerFragment
								.getSelection());
	...
	private void onError(Exception error) {
		// String text = getString(R.id.exception, error.getMessage());
